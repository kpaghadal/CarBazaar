...
import { SearchIcon, SellIcon, HeartIcon, ProfileIcon } from '../NavIcons';
        ...
        <div style={styles.headerContent}>
          <a href="/profile" className="logo-link">
            ...
            <div style={styles.logoText}>
              ...
              <span style={styles.logoSubtitle}>User Dashboard</span>
            </div>
          </a>
            ...
            <div style={styles.dropdownWrap} ref={dropdownRef}>
              ...
              {dropdownOpen && (
                <div style={styles.dropdown}>
                  <Link to="/sell" className="dropdown-item" onClick={() => setDropdownOpen(false)}>Sell old car</Link>
                  <Link to="/old-cars" className="dropdown-item" onClick={() => setDropdownOpen(false)}>Buy old car</Link>
                  <Link to="/chat" className="dropdown-item" onClick={() => setDropdownOpen(false)}>My Chats</Link>
                </div>
              )}
            </div>
...
const styles = {
  ...
  navLinkDropdown: { gap: 6 },
  chevron: { fontSize: 10, marginLeft: 2, display: 'inline-block' },
  dropdownWrap: { position: 'relative' },
  dropdown: {
    position: 'absolute', top: '100%', left: 0, marginTop: 4, minWidth: 160,
    backgroundColor: '#FFFFFF', borderRadius: 8, boxShadow: '0 4px 12px rgba(0,0,0,0.15)',
    border: '1px solid rgba(0,0,0,0.08)', padding: '8px 0', zIndex: 100,
